...
export default function Contact() {
  return (
    <section id="contact" className="py-16 smalltablet:py-20 pc:py-24 bg-gray-50">
      <div className="relative max-w-[1400px] mx-auto px-4 smalltablet:px-6 pc:px-8">
        ...
        <div className="grid pc:grid-cols-3 gap-10 smalltablet:gap-12 pc:gap-0 items-start">
          ...
          {/* Middle: 오시는 길 */}
          <div className="px-0 pc:px-12 text-center">
            <div className="flex flex-col items-center">
              <div className="w-24 h-24 smalltablet:w-28 smalltablet:h-28 rounded-full bg-gray-100 flex items-center justify-center mb-6 smalltablet:mb-8">
                <MapPin className="w-9 h-9 smalltablet:w-10 smalltablet:h-10 text-gray-700" strokeWidth={2} />
              </div>
          ...
          {/* Right: 유튜브 소개 */}
          <div className="pl-0 pc:pl-12 text-center">
            <div className="flex flex-col items-center">
              <div className="w-24 h-24 smalltablet:w-28 smalltablet:h-28 rounded-full bg-gray-100 flex items-center justify-center mb-6 smalltablet:mb-8">
                <Youtube className="w-9 h-9 smalltablet:w-10 smalltablet:h-10 text-gray-700" strokeWidth={2} />
              </div>
